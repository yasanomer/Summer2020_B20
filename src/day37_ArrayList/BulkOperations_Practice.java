...
public class BulkOperations_Practice {
    public static void main(String[] args) {
       ...
       ArrayList<String> students = new ArrayList<>();
        ...
        employees.addAll( Arrays.asList( "Ahmed", "Davud","Muhtar", "Ahmed", "Virginia", "Beslan", "Ibrahim", "Ahmed") );

        System.out.println(employees);
        // retainAll == only print search element
        employees.retainAll(  Arrays.asList( "Ahmed", "Massimo")  );
        System.out.println(employees+"==>");
    }
}
