...
public class String_Method {
    public static void main(String[] args) {
        ...
        char ch1 = str.charAt(1); // charter y

        System.out.println(ch1);

        // +
        String str2 = "Cybertek";
//        str2 = str2 + " School"; solution 1
        str2 = str2 +""+"School"; // solution 2
...
//   last index character k
        char ch2 = str3.charAt(l-1);
//        char ch2 = str3.charAt(str3.length()-1); // 2. solution
        ...
        //            012345678910   index number
        String word = str7.substring(7,11);
        System.out.println("==> "+str7);
        System.out.println(word);

       // String word2 = str7.substring(12,str7.length()); // solution1 Language
        String word2 = str7.substring(12); // solution2 Language
